...
import com.aitekteam.developer.labourer.Adapters.AchievementAdapter;
...
public class AchievementFragment extends Fragment {
    ...
    private View view;
    private ArrayList<AchievementModel> data_set;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pagesHandler.showPage(R.id.page_achievement);

        this.main_list = this.view.findViewById(R.id.page_achievement_list);
        ...
        this.insertDataSet();
        this.adapter = new AchievementAdapter(this.data_set);
    ...
    private void insertDataSet() {
        this.data_set.add(new AchievementModel("Cat Atap Rumah", "Sukabirus", 100, 0, 0, 0, 0));
        this.data_set.add(new AchievementModel("Cat Dinding Rumah", "Sukapura", 125, 0, 0, 0, 0));
        this.data_set.add(new AchievementModel("Cat Atap Rumah", "Babakan Ciamis", 50, 0, 0, 0, 0));
    }
}
